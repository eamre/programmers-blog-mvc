...
namespace ProgrammersBlog.Data.Concrete.EF.Mapping
{
    public class ArticleMap : IEntityTypeConfiguration<Article>
    {
        public void Configure(EntityTypeBuilder<Article> builder)
        {
            builder.HasKey(a => a.Id);//id yi primary key belırlıyoruz
            builder.Property(a => a.Id).ValueGeneratedOnAdd();//id alanının artmasını sağlıyor
            ...
            builder.Property(a => a.SeoAuthor).HasMaxLength(60);
